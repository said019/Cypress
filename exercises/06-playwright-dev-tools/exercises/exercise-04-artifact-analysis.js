/**
 * Ejercicio 04: Análisis de Artefactos de Tests
 * 
...
/**
 * TODO: Configura playwright.config.js con estas opciones:
 * 
 * use: {
...
test.describe('Videos', () => {
  ...
  test('video de test fallido', async ({ page }) => {
    await page.goto('https://rahulshettyacademy.com/client');
...
test.describe('Análisis de Fallos', () => {
  ...
  test('test fallido con artefactos completos', async ({ page, context }) => {
    // Inicia trace
    await context.tracing.start({
      screenshots: true,
      snapshots: true,
 ...
 *    npx playwright test exercise-04-artifact-analysis.js
 * 
